...
//     let ingredients = json[i].ingredients.hops;
//     for (let n = 0; n <= ingredients.length - 1; n++) {
//       let ko = ingredients[n].name;
//       hopArray.push(ko);
//     }
//   }
// };
// const NarrowDownMolt = () => {
//   for (let i = 0; i < json.length; i++) {
//     let ingredients = json[i].ingredients.malt;
//     for (let n = 0; n <= ingredients.length - 1; n++) {
//       let ko = ingredients[n].name;
//       moltArray.push(ko);
//     }
...
// NarrowDownMolt();
// // NarrowDown();
// // let newHop = hopArray.filter((x, i, self) => {
// //   return self.indexOf(x) === i;
// // });
// // let newMolt = moltArray.filter((x, i, self) => {
// //   return self.indexOf(x) === i;
// // });
// // // console.log(newHop);
// // console.log(newMolt);
